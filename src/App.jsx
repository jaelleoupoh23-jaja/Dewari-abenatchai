...
page: {   maxWidth: 420,   margin: '0 auto',   minHeight: '100vh',   background: 'radial-gradient(circle at top, #3C3489 0%, #1a1530 45%, #0a0815 100%)',   fontFamily: "'Poppins', sans-serif",   display: 'flex',   flexDirection: 'column',   boxSizing: 'border-box',   color: '#fff', },  barreNom: {   textAlign: 'center',   padding: '16px 0 4px',   fontWeight: 900,   fontSize: 18,   letterSpacing: 0.8,   color: '#EF9F27',   textShadow: '0 0 14px rgba(239,159,39,0.45)', },  banniere: {   height: 230,   display: 'flex',   flexDirection: 'column',   alignItems: 'center',   justifyContent: 'center',   position: 'relative',   padding: 20,   textAlign: 'center',   transition: 'background 0.6s ease',   borderRadius: '0 0 28px 28px',   boxShadow: '0 18px 40px rgba(0,0,0,0.35)', },  boutonPrincipal: {   width: '100%',   padding: 15,   background: 'linear-gradient(135deg,#EF9F27,#B76E00)',   color: '#120b24',   border: 'none',   borderRadius: 30,   fontWeight: 900,   fontSize: 15,   boxShadow: '0 8px 22px rgba(239,159,39,0.35)', },  ligneSalon: {   display: 'flex',   alignItems: 'center',   padding: '12px 14px',   background: 'rgba(255,255,255,0.08)',   border: '1px solid rgba(239,159,39,0.18)',   borderRadius: 16,   backdropFilter: 'blur(10px)', },  carteDe: {   display: 'flex',   alignItems: 'center',   padding: '18px',   borderRadius: 20,   background: 'linear-gradient(135deg,#EF9F27,#7B2CBF)',   cursor: 'pointer',   boxShadow: '0 14px 30px rgba(123,44,191,0.35)', },  carteLudo: {   display: 'flex',   alignItems: 'center',   padding: '18px',   borderRadius: 20,   background: 'linear-gradient(135deg,#3C3489,#EF9F27)',   cursor: 'pointer',   marginTop: 12,   boxShadow: '0 14px 30px rgba(239,159,39,0.25)', },  zoneDe: {   display: 'flex',   flexDirection: 'column',   alignItems: 'center',   textAlign: 'center',   background: 'rgba(255,255,255,0.08)',   border: '1px solid rgba(239,159,39,0.22)',   borderRadius: 22,   padding: '26px 18px',   marginTop: 18,   backdropFilter: 'blur(12px)',   boxShadow: '0 18px 40px rgba(0,0,0,0.28)', },  deCube: {   width: 92,   height: 92,   borderRadius: 22,   background: 'linear-gradient(135deg,#3C3489,#EF9F27)',   boxShadow: '0 0 28px rgba(239,159,39,0.45)',   display: 'flex',   alignItems: 'center',   justifyContent: 'center',   padding: 14, },  ludoPlateauWrap: {   display: 'flex',   justifyContent: 'center',   background: 'linear-gradient(135deg,#0a0815,#1a1530)',   border: '2px solid rgba(239,159,39,0.35)',   borderRadius: 22,   padding: 12,   boxShadow: '0 16px 36px rgba(0,0,0,0.45)', },
